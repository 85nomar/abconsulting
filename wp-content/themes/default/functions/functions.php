...
function responsive_read_more() {
    return ' <a href="' . get_permalink() . '">' . __('<div class="read-more"><b>Read more &#8250;</b></div><!-- end of .read-more -->', 'responsive') . '</a>';
}
...
function my_more_link( $more_link, $more_link_text ) {
    ...
    $read_more_bk = bi_get_data('read_more_block', '' );
    ...
    return str_replace( $more_link_text, '<p><a href="' . get_permalink() . '" class="readmore btn btn-default '.$read_more_block.'">'.$read_more_text.' </a> </p>', $more_link );
}
...
function responsive_breadcrumb_lists() {
    ...
    function responsive_widgets_init() {
        ...
        register_sidebar(array(
          ...
          register_sidebar(array(
            'name' => __('Left Footer', 'responsive'),
          ...
          register_sidebar(array(
            'name' => __('Middle Footer', 'responsive'),
            'description' => __('footer.php', 'responsive'),
            'id' => 'footer-middle',
            'before_title' => '<div class="footer-title"><h3>',
            'after_title' => '</h3></div>',
          ...
          register_sidebar(array(
            'name' => __('Right Footer', 'responsive'),
            'description' => __('footer.php', 'responsive'),
            'id' => 'footer-right',
            'before_title' => '<div class="footer-title"><h3>',
            'after_title' => '</h3></div>',
